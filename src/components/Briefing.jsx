      ...
      <div className="wrap">
        ...
        <div className="brief-grid">
          ...
          <div className="brief-card">
            ...
            <p>
              انفرادی و با ریتم خودت (این فاز قبل از تشکیل تیم‌هاست). همه‌چی روی ماشین خودت با Docker بالا میاد؛ نه سرور می‌خواد نه ماشین مجازی. حدود یک هفته برنامه‌ریزی کن. هر جا گیر کردی از منتورت بپرس — گیر کردن بخشی از یادگیریه، اما ساعت‌ها موندن نه.
            </p>
            <div className="chips">
              <span className="chip">انفرادی</span>
              <span className="chip">۶ روز</span>
              <span className="chip">روی Docker</span>
            </div>
          </div>
          <div className="brief-card">
            <h3>
