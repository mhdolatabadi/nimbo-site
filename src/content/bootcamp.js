...
export const weeks = [
  {
    ...
    objectives: [
      'مدل کافکا: تاپیک، پارتیشن، کانسیومر گروپ، و مدیریت آفست',
      'فرمت ستونی و ساختار داخلی Parquet',
      'رفتار HDFS در برابر حجم و تعداد فایل',
      'جدا کردن پیکربندی از ایمیج',
      'ساخت پایپ‌لاین استقرار خودکار',
    ],
